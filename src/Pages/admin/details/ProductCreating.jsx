      ...
      <div className="bg-white  p-4 rounded-lg ">
        <div className="flex justify-between">
          <div className="image flex items-center h-[60%] my-5">
            ...
            <div className="main-image ml-4 overflow-auto no-scrollbar">
              <img
                src={revImg ? revImg : thumbnail}
                className="w-[450px] h-[280px] rounded-lg shadow-xl border opacity-0 animate-appear transition-all duration-200 hover:scale-150 overflow-auto"
              ></img>
            </div>
          </div>
